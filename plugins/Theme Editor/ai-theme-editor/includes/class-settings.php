...
class WPAI_Settings {
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" id="wpai_max_tokens" name="wpai_max_tokens"
                                ...
                                min="1024" max="32000" class="small-text" />
                            <p class="description">Maximum tokens Claude can return. Edit mode must return the entire file — large theme files need 16,000+. Raise this if edits come back incomplete. Default: 16000.</p>
                        </td>
                    </tr>
    ...
    public static function get_max_tokens(): int {
        return (int) get_option( 'wpai_max_tokens', 16000 );
    }
