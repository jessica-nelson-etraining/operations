...
<head>
    ...
    <link rel="stylesheet" href="<?php echo ETPB_URL; ?>assets/theme-main.css" />

    <!-- Landing page CSS — contains hero, trust bar, enrollment card, stats strip etc. -->
    <link rel="stylesheet" href="<?php echo ETPB_URL; ?>assets/landing-page.css" />

    <!-- Frontend CSS — Core Blocks styles for General and Social Proof blocks -->
    <link rel="stylesheet" href="<?php echo ETPB_URL; ?>assets/frontend.css" />
